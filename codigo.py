...
archivo_csv = os.path.join('batting.csv')
...
archivo_csv1 = os.path.join('nfldata.csv')
nfl_data = pd.read_csv(archivo_csv1)
 
#Cargar los datos de Futbol soccer
archivo_csv2 = os.path.join('estadisticasftmx.csv')
futbol_data = pd.read_csv(archivo_csv2, encoding='ISO-8859-1')
...
def save_feedback():
    ...
    # Guardar los datos del feedback en un archivo CSV
